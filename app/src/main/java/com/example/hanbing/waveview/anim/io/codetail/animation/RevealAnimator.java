...
import static com.example.hanbing.waveview.anim.io.codetail.animation.ViewAnimationUtils.SimpleAnimationListener;
...
public interface RevealAnimator {
     ...
     * @see android.view.View#invalidate(android.graphics.Rect)
     */
    void invalidate(Rect bounds);

    /**
     * {@link ViewAnimationUtils#createCircularReveal(android.view.View, int, int, float, float)} is
     ...
     * @see com.example.hanbing.waveview.anim.io.codetail.animation.RevealAnimator.RevealInfo
     */
